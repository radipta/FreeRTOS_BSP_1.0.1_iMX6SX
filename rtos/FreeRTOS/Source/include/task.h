...
void delaytask(uint32_t timewake) PRIVILEGED_FUNCTION;
ListItem_t* getCurrentListTCB() PRIVILEGED_FUNCTION;
uint32_t getTick()PRIVILEGED_FUNCTION;
uint32_t getCurrentTCB()PRIVILEGED_FUNCTION;
/*
 *  Fungsi digunakan Semaphore
 */
uint32_t insertSemTCB(void* addr)PRIVILEGED_FUNCTION;
uint32_t checkSemTCB()PRIVILEGED_FUNCTION;
void* getSemTCB()PRIVILEGED_FUNCTION;
